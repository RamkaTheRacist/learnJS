...
function groupById(array) {
    return array.reduce((object, value) => {    //Открывет object => {}
        object[value.id] = value;               //Добавляет ключ по id
        return object                           //Возвращает остальную часть объекта
    },   {});                                   //Складывает в общий object , {})
}
